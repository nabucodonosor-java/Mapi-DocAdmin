...
const MedicosEspecializacaoFilters = ({ nome, handleChangeName, especializacao, handleChangeEspecializacao, clearFilters }: Props) => {
...
export default MedicosEspecializacaoFilters;